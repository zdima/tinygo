...
func getClangHeaderPath(TINYGOROOT string) string {
	...
	if runtime.GOOS == "linux" {
		...
		if llvmMajor == "9" {
			// Work around a bug in the LLVM 9 package on Debian. The symlink
			// /usr/lib/clang/9/include is broken, it points to
			// /usr/lib/llvm-9/lib/clang/9.0.0/include while it should point to
			// /usr/lib/llvm-9/lib/clang/9.0.1/include. Therefore, add the full
			// path manually.
			patterns = append(patterns, "/usr/lib/llvm-9/lib/clang/*/include")
		}
	}
